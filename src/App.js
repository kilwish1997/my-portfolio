        ...
        <div style={{
          ...
          <div className="contact-card" style={{
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 32 }}>
              ...
              <a href="https://www.linkedin.com/in/prince-tewatia-181a42192x" target="_blank" rel="noopener noreferrer" style={{ color: '#4fc3f7', fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <a href="https://www.instagram.com/prince.tewatia_?igsh=MW5ram54NHI4cmtrbA==" target="_blank" rel="noopener noreferrer" style={{ color: '#e1306c', fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', marginBottom: 24 }}>
            <a href="https://linkedin.com/in/princetewatia" target="_blank" rel="noopener noreferrer" style={{ color: '#a084fa', textDecoration: 'none', fontWeight: 600, fontSize: 28 }} title="LinkedIn" aria-label="LinkedIn">
            ...
            <a href="https://instagram.com/yourprofile" target="_blank" rel="noopener noreferrer" style={{ color: '#e1306c', textDecoration: 'none', fontWeight: 600, fontSize: 28 }} title="Instagram" aria-label="Instagram">
